...
def render_tab(tab):
    ...
    if tab == 'tab1':
        return html.Div([
            ...
            dcc.Graph(id='map-graph', figure=fig_map, style={'height': '60vh'}),
            dcc.Graph(id='bar-graph', figure=fig_bar, style={'height': '35vh'})
        ])
    elif tab == 'tab2':
        return html.Div([
...
def update_parish(selectedData):
...
def update_price_review(review_threshold):
